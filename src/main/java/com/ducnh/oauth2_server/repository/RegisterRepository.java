...
public interface RegisterRepository extends CrudRepository<RegisterEvent, RegisterIdentity>{
    ...
    @Query(value = "select r.athlete_id, a.first_name + \" \" + a.last_name as athlete_name, r.event_id, e.event_name, r.team_id, r.created_at as registered_at from strava_register r left join strava_user a on r.athlete_id = a.id "
